...
.add(routerConfig.checkout_success)
.add(routerConfig.customer_login)
.add(routerConfig.customer_register)
.add(routerConfig.customer_forgot_password)
.add(routerConfig.customer_create_password)
.add(routerConfig.customer_logout)
.add(routerConfig.contact)
.add(routerConfig.customer)
