        ...
        return (
            <div key={Identify.makeid()} className="item-subtotal">
                {tax_cart_display_subtotal === 1 && totals.subtotal_excl_tax !== undefined && (
                    <div className="checkout-total-item">
                        <span className="total-label"
                              style={{color: configColor.content_color}}>{Identify.__('Subtotal') + ':'}</span>
                ...
                {tax_cart_display_subtotal === 2 && totals.subtotal_incl_tax !== undefined && (
                    <div className="checkout-total-item">
                        <span className="total-label"
                              style={{color: configColor.content_color}}>{Identify.__('Subtotal') + Identify.__(':')}</span>
                ...
                {tax_cart_display_subtotal === 3 && (
                    <React.Fragment>
                        {totals.subtotal_excl_tax !== undefined && (
                            <div className="checkout-total-item">
                            <span className="total-label"
                                  style={{color: configColor.content_color}}>{Identify.__('Subtotal (Excl. Tax)') + Identify.__(':')}</span>
                                <span className="total-price"><Price prices={{price: totals.subtotal_excl_tax}}/></span>
                            </div>
                        )}
                        {totals.subtotal_incl_tax !== undefined && (
                            <div className="checkout-total-item">
                            <span className="total-label"
                                  style={{color: configColor.content_color}}>{Identify.__('Subtotal (Incl. Tax)') + Identify.__(':')}</span>
                                <span className="total-price"><Price prices={{price: totals.subtotal_incl_tax}}/></span>
                            </div>
                        )}
                    </React.Fragment>
        ...
        return (
            <div key={Identify.makeid()} className="item-shipping-total">
                {tax_cart_display_shipping === 1 && totals.shipping_hand_excl_tax !== undefined && (
                    <div className="checkout-total-item">
                        <span className="total-label"
                              style={{color: configColor.content_color}}>{Identify.__('Shipping') + ':'}</span>
                ...
                {tax_cart_display_shipping === 2 && totals.shipping_hand_incl_tax !== undefined && (
                    <div className="checkout-total-item">
                        <span className="total-label"
                              style={{color: configColor.content_color}}>{Identify.__('Shipping') + Identify.__(':')}</span>
                ...
                {tax_cart_display_shipping === 3 && (
                    <React.Fragment>
                        {totals.shipping_hand_excl_tax !== undefined && (
                            <div className="checkout-total-item">
                            <span className="total-label"
                                  style={{color: configColor.content_color}}>{Identify.__('Shipping (Excl. Tax)') + Identify.__(':')}</span>
                        ...
                        {totals.shipping_hand_incl_tax !== undefined && (
                            <div className="checkout-total-item">
                            <span className="total-label"
                                  style={{color: configColor.content_color}}>{Identify.__('Shipping (Incl. Tax)') + Identify.__(':')}</span>
                                <span className="total-price"><Price
    ...
    renderDiscount = () => {
        ...
        if (totals.discount !== undefined && parseFloat(totals.discount) !== 0) {
            return (
                <div className="checkout-total-item">
                            <span className="total-label"
                                  style={{color: configColor.content_color}}>{Identify.__('Discount') + couponCode + ':'}</span>
                    <span className="total-price"><Price
    ...
    rendertax = () => {
        ...
        if (totals.tax !== undefined && parseFloat(totals.tax) !== 0) {
            return (
                <div className="checkout-total-item">
                            <span className="total-label"
                                  style={{color: configColor.content_color}}>{Identify.__('Tax') + ':'}</span>
                    <span className="total-price"><Price
        ...
        return (
            <div key={Identify.makeid()} className="item-grandtotal">
                ...
                && parseFloat(totals.grand_total_incl_tax) !== 0 && (
                    ...
                    <div className="checkout-total-item">
                        <span className="total-label"
                              style={{color: configColor.content_color}}>{Identify.__('Grand Total') + ':'}</span>
                ...
                {tax_cart_display_grandtotal === 1 && (
                    <React.Fragment>
                        {totals.grand_total_excl_tax !== undefined && parseFloat(totals.grand_total_excl_tax) !== 0 && (
                            <div className="checkout-total-item">
                            <span className="total-label"
                                  style={{color: configColor.content_color}}>{Identify.__('Grand Total (Excl. Tax)') + ':'}</span>
                                <span className="total-price"><Price
                        ...
                        {totals.grand_total_excl_tax !== undefined && parseFloat(totals.grand_total_excl_tax) !== 0 && (
                            <div className="checkout-total-item">
                            <span className="total-label"
                                  style={{color: configColor.content_color}}>{Identify.__('Grand Total (Incl. Tax)') + ':'}</span>
                                <span className="total-price"><Price
